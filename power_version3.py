...
def Calulation(name,data1,data2,total):
...
def General_Filter(name,data1,data2,data3,data4,data5,data6,total):
	TP,FP,TN,FN = (0 for i in range(4))
...
General_Filter('General_Filter',df['Great Filter'],df['POW'],df['ACH'],df['AFF'],Pass_count,Removed_count,total)
Calulation('Power',df['Great Filter'], df['POW'],total)
Calulation('Achievement',df['Great Filter'], df['ACH'],total)
Calulation('Affiliation',df['Great Filter'], df['AFF'],total)
